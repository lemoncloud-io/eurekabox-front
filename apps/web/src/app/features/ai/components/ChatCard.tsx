...
export const ChatCard = ({ chat, index, isSending, onDelete, onScroll, scrollRef, cardHeight }: ChatCardProps) => {
    ...
    return (
        <>
            <Card className={`flex flex-col p-0 border border-[#EAEAEC] dark:border-[#3A3C40] ${cardHeight}`}>
                    ...
                    <CardTitle className="flex-1 text-sm font-medium flex items-center justify-between">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem className="text-error" onClick={() => onDelete(chat.id)}>
            ...
            <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
                <DialogContent>
                    ...
                    <div className="flex gap-2 justify-center items-center mt-10">
                        ...
                        <Button onClick={handleUpdateChat} disabled={updateChat.isPending} className="flex-1 ">
